...
void main() {
  ...
  SoatModel soatWithExpiry(DateTime expiryDate) => SoatModel(
        id: 'soat-1',
        vehicleId: 'vehicle-1',
  ...
  group('SoatModel — status badge logic (US-2-6)', () {
    ...
    test('TC-2-21: status is expiringSoon when expiry is exactly 30 days away', () {
    ...
    test('TC-2-26: copyWith returns updated model with unchanged fields intact', () {
