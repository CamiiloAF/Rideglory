...
void main() {
  group('VehicleSelectorLoading', () {
    testWidgets('TC-vsel-1: shows CircularProgressIndicator', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: VehicleSelectorLoading())),
      );
      expect(find.byType(CircularProgressIndicator), findsOneWidget);
    });

    testWidgets('TC-vsel-2: shows no text (not empty-state text)', (
      tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: VehicleSelectorLoading())),
    ...
    testWidgets('TC-vsel-3: widget is centered inside a Padding', (
      tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: VehicleSelectorLoading())),
