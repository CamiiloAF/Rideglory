...
class SoatManualFormPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _SoatManualFormView(vehicle: vehicle, existingSoat: existingSoat),
    );
  }
}

class _SoatManualFormView extends StatefulWidget {
  const _SoatManualFormView({
    required this.vehicle,
    this.existingSoat,
  });
  ...
  @override
  State<_SoatManualFormView> createState() => _SoatManualFormViewState();
}

class _SoatManualFormViewState extends State<_SoatManualFormView> {
            ...
            child: FormBuilder(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SectionHeader(label: context.l10n.soat_section_data),
