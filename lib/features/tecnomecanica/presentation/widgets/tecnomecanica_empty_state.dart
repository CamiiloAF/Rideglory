...
/// Also shows [TecnomecanicaExemptionNotice] above the CTA when applicable.
class TecnomecanicaEmptyState extends StatelessWidget {
  const TecnomecanicaEmptyState({super.key, required this.vehicle});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppSpacing.gapSm,
            Text(
              context.l10n.tecnomecanica_manual_note,
