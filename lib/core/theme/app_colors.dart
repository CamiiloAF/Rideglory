...
class AppColors {
  ...
  static Color primaryShadow({double opacity = 0.3}) =>
  ...
  // Event type colors
  static const Color eventOffRoad = Color(0xFF8B4513); // Brown
  static const Color eventOnRoad = primary;
  static const Color eventExhibition = Color(0xFF9333EA); // Purple
  static const Color eventCharitable = Color(0xFF14B8A6); // Teal

  // Event difficulty
  static const Color difficultyChip = Color(0xFFEF4444); // Red

  // Event pricing
  static const Color eventFree = Color(0xFF10B981); // Green
  static const Color eventPaid = Color(0xFFD946EF); // Fuchsia/Magenta
