...
> Última actualización: 2026-06-04 — ✅ FEATURE COMPLETO: las 11 fases commiteadas en feat/analytics-crashlytics (623 tests verdes, analyze limpio). Pendiente: verificación manual en GA4 DebugView / consola Crashlytics y crash simbolizado en build release (CA-1).
...
| 8 | Tracking en vivo + SOS (solo hitos) | normal | ✅ commiteada | 5720cc2 | 6 hitos aditivos + seam test SOS; 337 tests. |
| 9 | Garaje, mantenimientos, SOAT, perfil, descubrimiento | lite | ✅ commiteada | 4dc0bd8 | 15 eventos + has_vehicle; 353 tests. |
| 10 | Auditoría no-PII transversal + doc QA | normal | ✅ commiteada | 9cf65c9 | Audit limpio + doc QA + guardián; 618 tests. |
| 11 | Privacidad: opt-out en perfil + política | normal | ✅ commiteada | c00fbda | AppSwitch + opt-out (Analytics+Crashlytics) + política; 623 tests. |
